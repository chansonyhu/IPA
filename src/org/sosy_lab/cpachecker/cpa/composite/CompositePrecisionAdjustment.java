...
public class CompositePrecisionAdjustment implements PrecisionAdjustment {
  ...
  public Optional<PrecisionAdjustmentResult> prec(
    ...
    if(pPrecision instanceof PredicatePrecision) {
      CompositePrecision cp;
      List<Precision> wrappedPrecision = new ArrayList<>();
      wrappedPrecision.add(SingletonPrecision.getInstance());
      wrappedPrecision.add(SingletonPrecision.getInstance());
      wrappedPrecision.add(SingletonPrecision.getInstance());
      wrappedPrecision.add(pPrecision);
      wrappedPrecision.add(SingletonPrecision.getInstance());
      wrappedPrecision.add(SingletonPrecision.getInstance());
      cp = new CompositePrecision(wrappedPrecision);
      pPrecision = cp;
      GlobalInfo.getInstance().currentReached.updatePrecision(GlobalInfo.getInstance().currentElement,
          pPrecision);
    }
...
//      if(CPAMain.isReuseInvariant && oldElement instanceof PredicateAbstractState && ImpactedHelper.isHit) {
//        //TODO uncomment them when all the code complete
//        outElements.add(oldElement);
//        outPrecisions.add(oldPrecision);
