...
public class ModificationsTransferRelation extends SingleEdgeTransferRelation {
  ...
  public Collection<? extends AbstractState> getAbstractSuccessorsForEdge0(
  ...
  private boolean containsDeclaration(final Set<String> varNames, final String varName) {
