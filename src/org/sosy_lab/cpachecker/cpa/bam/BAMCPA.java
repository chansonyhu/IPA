...
public class BAMCPA extends AbstractSingleWrapperCPA implements StatisticsProvider, ProofChecker {
  ...
  private static BlockPartitioning partitioning = null;
  ...
  public static BAMCPAStatistics stats;
  ...
  private PartitioningHeuristic getPartitioningHeuristic() throws CPAException, InvalidConfigurationException {
    //logger.log(Level.SEVERE, "blockHeuristic: " + blockHeuristic.getTypeName());
  ...
  public static BlockPartitioning getPartitioning() {
    Preconditions.checkNotNull(partitioning);
    return partitioning;
  }
