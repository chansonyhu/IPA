...
public class CallstackState implements AbstractState, Partitionable, AbstractQueryableState, Serializable {
  ...
  public Object getPartitionKey() {
    if(CPAMain.isIncPred) {
      return Quartet.with(previousState, currentFunction, callerNode, depth).hashCode();
    } else
      return this;
  }
  ...
  public boolean equals(Object obj) {
    ...
    if(CPAMain.isIncPred && IncrementalPAUtil.getInstance().curTarget == 100) {
//    if(false) {
      CallstackState target = (CallstackState) obj;
      boolean e2 = this.currentFunction
          .equals(target.currentFunction)
          && this.callerNode.equals(target.callerNode) && this.depth == target.depth;
      if(this.previousState == null && target.previousState == null)
        return e2;
      else if(this.previousState == null)
        return false;
      else
        return this.previousState.equals(target.previousState) && e2;
    } else
