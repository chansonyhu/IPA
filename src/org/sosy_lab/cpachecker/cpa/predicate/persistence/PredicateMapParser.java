...
public class PredicateMapParser {
  ...
  @Option(secure=true, name="applyFunctionWide", description="Apply location-specific predicates to all locations in their function")
  private boolean applyFunctionWide = false;

  @Option(secure=true, name="applyGlobally", description="Apply location- and function-specific predicates globally (to all locations in the program)")
