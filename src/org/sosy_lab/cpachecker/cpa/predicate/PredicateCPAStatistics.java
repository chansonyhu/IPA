...
class PredicateCPAStatistics extends AbstractStatistics {
  ...
  private boolean exportInvariants = false;
  ...
  private Path abstractionsFile = null;
  ...
  private Timer writePrecisionTimer = new Timer();
  ...
  public PredicateCPAStatistics(PredicateCPA pCpa, BlockOperator pBlk,
    ...
    if (exportPredmap && predmapFile != null) {
      GlobalInfo.getInstance().predicate_fs = predmapFile.toFile().length();
   ...
   */
  public static class MutablePredicateSets {
    ...
    public final SetMultimap<Pair<CFANode, Integer>, AbstractionPredicate> locationInstance;
  ...
  public void printStatistics(PrintStream out, Result result, ReachedSet reached) {
    ...
    if (exportPredmap && predmapFile != null) {
      ...
      out.println("Read Precision Time:            " + cpa.getPrecisionBootstraper().getReadPrecisionTimer());
      out.println("Precision file size:                " + GlobalInfo.getInstance().predicate_fs);
      out.println("Write Precision Time:           " + writePrecisionTimer);
    }
    ...
    if (prec.numAbstractions > 0) {
      GlobalInfo.getInstance().lastAbstractions = prec.numAbstractions;
