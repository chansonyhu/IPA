...
public class FormulaManagerView implements StatisticsProvider {
  ...
  public FormulaManagerView(FormulaManagerFactory solverFactory, Configuration config, LogManager pLogger) throws InvalidConfigurationException {
    ...
    QuantifiedFormulaManager qfm = manager.getQuantifiedFormulaManager();
    if(qfm == null && ImpactedHelper.getInstance().isQEliminate) {
      qfm = GlobalInfo.getInstance().z3fm.getQuantifiedFormulaManager();
    }
    quantifiedFormulaManager = new QuantifiedFormulaManagerView(wrappingHandler, qfm, booleanFormulaManager, integerFormulaManager);
