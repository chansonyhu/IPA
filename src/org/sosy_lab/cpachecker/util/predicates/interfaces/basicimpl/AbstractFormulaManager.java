...
public abstract class AbstractFormulaManager<TFormulaInfo, TType, TEnv> implements FormulaManager {
  ...
  public abstract void serializeFormula(TFormulaInfo t) throws IOException;
  ...
  @Override
  public void serializeFormula(BooleanFormula t) throws IOException {
    serializeFormula(formulaCreator.extractInfo(t));
  }
  ...
  public final TEnv getEnvironment() {
    //if(InterpolationManager.isNewEnv)
    //  return getFormulaCreator().getOriEnv();
