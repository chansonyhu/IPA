...
public class SmtInterpolBooleanFormulaManager extends AbstractBooleanFormulaManager<Term, Sort, SmtInterpolEnvironment> {
  ...
  public Term and(Term pBits1, Term pBits2) {
    if(pBits1.toString().equals("false") || pBits2.toString().equals("false"))
