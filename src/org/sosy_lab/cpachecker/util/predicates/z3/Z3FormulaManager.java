...
import org.sosy_lab.cpachecker.util.predicates.smtInterpol.ResolveTerm;
import org.sosy_lab.cpachecker.util.predicates.smtInterpol.SerializeTerm;
...
public class Z3FormulaManager extends AbstractFormulaManager<Long, Long, Long> implements AutoCloseable {
  ...
  public BooleanFormula encapsulateBooleanFormula(long t) {
  ...
  @Override
  public void setOutputStream(DataOutputStream pOut, File pDictionaryFile) throws FileNotFoundException {
    this.serialize = new SerializeTerm(pOut, pDictionaryFile);
  }
  ...
  @Override
  public void setInputStream(DataInputStream pIn, File pDictionaryFile) throws IOException {
    this.resolve = new ResolveTerm(pIn, pDictionaryFile);
  }
  ...
  @Override
  public int addSerializeDictionary(int pType, String pValue) {
    if(this.serialize == null) {
      throw new IllegalArgumentException("set outputstream first.");
    }
    switch (pType) {
      case 0:
        return this.serialize.addKeyMap(pValue);
      case 1:
        return this.serialize.addFvarMap(pValue);
      case 2:
        return this.serialize.addCseMap(pValue);
      default:
  ...
  @Override
  public String getResolveDictionary(int pType, int pValue) {
    if(this.resolve == null) {
      throw new IllegalArgumentException("set inputstream first.");
    }
    switch (pType) {
      case 0:
        return this.resolve.getKeyValue(pValue);
      case 1:
        return this.resolve.getFvarValue(pValue);
      case 2:
        return this.resolve.getCseValue(pValue);
      default:
        throw new IllegalArgumentException("type not in 0,1,2.");
    }
  }
  ...
  @Override
  public void serializeFormula(Long pT) throws IOException{
  ...
  @Override
  public void resolveFormula(StringBuilder pBuilder) throws IOException {
    this.resolve.resolve(pBuilder);
  }
}