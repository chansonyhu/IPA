    ...
    static Map<String, String> processArguments(final String[] args) throws InvalidCmdlineArgumentException {
        ...
        while (argsIt.hasNext()) {
            ...
            if (   handleArgument0("-stats",   "statistics.print", "true",            arg, properties)
                    || handleArgument0("-loopSummary", "loopSummary", "true", arg, properties)
                    || handleArgument0("-onlyLoopSummary", "onlyLoopSummary", "true", arg, properties)
                    || handleArgument0("-onlyFunctionSummary", "onlyFunctionSummary", "true", arg, properties)
                    ...
                    || handleArgument1("-summaryInputPath", "summaryInputPath", arg, argsIt, properties)
                    || handleArgument1("-summaryOutputPath", "summaryOutputPath", arg, argsIt, properties)
                    || handleArgument1("-invariantInputPath", "invariantInputPath", arg, argsIt, properties)
                    || handleArgument1("-invariantOutputPath", "invariantOutputPath", arg, argsIt, properties)
                    || handleArgument0("-useTextSummary", "useTextSummary", "true", arg, properties)
                    || handleArgument0("-LazyExpansion", "LazyExpansion", "true", arg, properties)
                    || handleArgument0("-noReduction", "noReduction", "true", arg, properties)
                    || handleArgument0("-onlyParsing", "onlyParsing", "true", arg, properties)
                    || handleArgument0("-isIncPred", "isIncPred", "true", arg, properties)
                    || handleArgument0("-isHeuristicAddingMultiEdge", "isHeuristicAddingMultiEdge", "true", arg, properties)
                    || handleArgument0("-subgraph", "subgraph", "true", arg, properties)
                    ) {
                // nothing left to do
