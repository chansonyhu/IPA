...
public final class CEnumType implements CComplexType, Serializable{

  transient private final ImmutableList<CEnumerator> enumerators;
  ...
  public CEnumType(final boolean pConst, final boolean pVolatile,
    ...
    /*
    scripts/cpa.sh -heap 15000M -config config/predicateAnalysis.properties -outputpath exp/impactedAnalysis/exec-out/acpi--fan.c_1/impacted -disable-java-assertions -stats -setprop cpa.predicate.abstraction.initialPredicates=exp/impactedAnalysis/exec-out/acpi--fan.c_0/impacted/predmap.txt -setprop cpa.impacted.invariants.export=true -setprop cpa.impacted.pre_invariants.file=../../acpi--fan.c_0/impacted/impacted-invariants.txt -setprop cpa.impacted.old.file=acpi--fan.c_0/acpi--fan.c -timelimit 90s /media/yqs17/47b80e29-18ee-456c-9663-c689a9110456/home/qianshan/Exp/cpachecker-summary/exp/lazyExpansion/ldv-benchmark/acpi--fan.c_1/acpi--fan.c
     */
    if(pEnumerators == null) {
      enumerators = null;
    } else {
  ...
  public static final class CEnumerator extends AbstractSimpleDeclaration implements CSimpleDeclaration, Serializable{

    transient private final @Nullable Long  value;
    transient private CEnumType             enumType;
    transient private final String         qualifiedName;
