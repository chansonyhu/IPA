...
public class CFABuilder extends ASTVisitor {
  ...
  private Set<CVariableDeclaration> inpactedGlobalInitializedVariables = new HashSet<>();
...
//      //
//
//      if(((IASTSimpleDeclaration) declaration).getDeclarators()[0] instanceof CASTDeclarator) {
//        if(((IASTSimpleDeclaration) declaration).getDeclarators()[0].getName().toString().equals("x")) {
//          List<CDeclaration> tmp = astCreator.convert((IASTSimpleDeclaration)declaration);
//          inpactedGlobalInitializedVariables.add((CVariableDeclaration) tmp.get(0));
//          ImpactedHelper.getInstance().inpactedGlobalInitializedVariables.addAll(inpactedGlobalInitializedVariables);
//        }
//      }
