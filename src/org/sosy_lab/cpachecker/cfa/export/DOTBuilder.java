...
public final class DOTBuilder {
  ...
  @Option(secure=true, name="cfa.export.line_number",
          description="export CFA with line number")
  public boolean isLineNumber = true;
...
//          }
  ...
  private static class DotGenerator implements CFATraversal.CFAVisitor {
    ...
    private static String formatEdge(CFAEdge edge) {
      ...
      sb.append(escapeGraphvizLabel(edge.getDescription() + functionName, " "));
