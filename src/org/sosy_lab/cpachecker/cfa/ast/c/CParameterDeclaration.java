 ...
 */
public final class CParameterDeclaration extends AParameterDeclaration implements Serializable, CSimpleDeclaration {

  private String qualifiedName;

  //TODO qianshan may be wrong when deserialization
  private static final long serialVersionUID = 3701900417675560500L;
  ...
  public CParameterDeclaration(CParameterDeclaration pPD) {
    super(pPD.getFileLocation(), pPD.getType(), checkNotNull(pPD.getName()));
    qualifiedName = pPD.qualifiedName;
  }
